...
flag=2
    ...
    if(box8.isTouching(ball)&&ball.bounceOff(box8)){
        ...
        ball.scale=+0.1
        music2.play();
        ball.shapeColor=rgb(11,110,100);
        flag=8
    }
